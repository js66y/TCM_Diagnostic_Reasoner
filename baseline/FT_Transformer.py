...
# =============================================================================
# Everything above this line is the unmodified official FT-Transformer source
# from yandex-research/rtdl-revisiting-models, commit
# e3ed46cac38568785289d8fa16b8cfa585bde27e.
...
class FTTransformerTCM(_TCMConditionalDoseOutput):
    """Official FT-Transformer adapted to TCM-EHR herb and dosage prediction."""

    checkpoint_version = 'official-ft-transformer-tcm-v1'
    ...
    def __init__(
        ...
        self.core = FTTransformer(
            n_cont_features=1,
            cat_cardinalities=tcm_categorical_cardinalities(
                cardinalities,
                method_dim,
            ),
            d_out=num_herb,
    ...
    def optimizer_parameter_groups(self) -> List[Dict[str, Any]]:
        groups = self.core.make_parameter_groups()
        groups.append({'params': list(self.dose_head.parameters())})
        return groups
...
FTTransformerOfficialModel = FTTransformerTCM
__all__.extend(
    [
        'FTTransformerTCM',
        'FTTransformerOfficialModel',
        'ft_transformer_tcm_loss',
